...
class RNNFootballPredictionModel(nn.Module):
    def __init__(self, game_output=32, team_output=32, embedding_output = 9, combined = 32, hidden_size = 256):
        ...
        self.team_stats_layer = nn.RNN(self.team_input, self.hidden_size, batch_first=True)
